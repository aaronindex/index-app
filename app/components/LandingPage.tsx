...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen bg-[#FAF8F6] dark:bg-[#121211]">
            ...
            <div className="text-center lg:text-left lg:col-span-2">
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-base opacity-75 text-[#121211] dark:text-[#FAF8F6]">In GPT, Claude, Cursor</p>
                </div>
                <div>
                  <div className="inline-block text-xs font-semibold tracking-wider uppercase opacity-60 mb-2 text-[#121211] dark:text-[#FAF8F6]">
                    Import
      ...
      {/* 6) FOOTER */}
      <footer className="w-full py-8 border-t border-[#121211]/10 dark:border-[#FAF8F6]/10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-sm text-[#121211] dark:text-[#FAF8F6] opacity-60">
            <a
