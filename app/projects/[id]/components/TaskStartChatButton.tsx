// app/projects/[id]/components/TaskStartChatButton.tsx
'use client';

import { useState } from 'react';
import StartChatModal from '@/app/components/StartChatModal';

interface TaskStartChatButtonProps {
  taskId: string;
}

export default function TaskStartChatButton({ taskId }: TaskStartChatButtonProps) {
    ...
    return (
      <>
        <button
          ...
          title="Get AI help on this task"
        >
  ...
  return (
    <>
      ...
      <StartChatModal
        ...
        contextBlock={{
          project: undefined,
          source: 'decision', // Placeholder
          summary: 'Task Start Chat',
          suggestedExploration: 'Resolve/Plan/Debug this task',
